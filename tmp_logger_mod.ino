...
#define SD_PWR_PIN      9               // SD card power pin 3v3 will be managed by ESP32 GPIO
...
void setup() {
  ...
  // Initialize SD card
  pinMode(SD_PWR_PIN, OUTPUT);  // Set GPIO as an output pin
  digitalWrite(SD_PWR_PIN, HIGH); // Power SD card module
...
void loop () {
  ...
  if (DEBUG_MODE) {
    ...
    digitalWrite(SD_PWR_PIN, LOW); // Cut power to SD Card module 
